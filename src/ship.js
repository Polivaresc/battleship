function shipFactory (initial_pos, len, direction) {
    // const hitPositions = []
    const final_pos = calculateFinalPos(initial_pos, len, direction)
    ...
    return { len, initial_pos, final_pos }
}

function calculateFinalPos(initial_pos, len, direction) {
